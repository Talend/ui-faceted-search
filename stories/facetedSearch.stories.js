...
import {
  createBadgesDict,
  getBadgesFromDict,
} from "../src/dictionary/badge.dictionary";
  ...
  .add("default", () => (
    <div>
      <FacetedSearch.Faceted id="my-faceted-search">
        {(currentFacetedMode) =>
          (currentFacetedMode ===
            FacetedSearch.constants.FACETED_MODE.ADVANCED && (
            <FacetedSearch.AdvancedSearch onSubmit={action("onSubmit")} />
          )) ||
          (currentFacetedMode ===
            FacetedSearch.constants.FACETED_MODE.BASIC && (
      ...
      <div>
        <BadgeFacetedProvider value={{}}>
          <BadgesGenerator
            badges={[
              set(
                cloneDeep(badgesFaceted.badges[0]),
                "properties.readOnly",
                true
              ),
              set(
